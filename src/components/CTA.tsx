...
export function CTA() {
  ...
  return (
    <section
      ref={ref}
      className="py-20 bg-gradient-to-br from-[#002B60] via-[#004EA8] to-[#0094FF] relative overflow-hidden scroll-smooth"
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          Junte-se a dezenas de empresas que já aumentaram a sua visibilidade e
          vendas com a EG Mídia Digital.
        </motion.p>
        ...
        >
          {/* Botão que leva até a section contact */}
          <motion.a
            href="#contato"
